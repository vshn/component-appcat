...
instance ?= defaults
test_instances = tests/defaults.yml tests/vshn-cloud.yml tests/vshn-managed.yml tests/control-plane.yml tests/service-cluster.yml tests/dev.yml tests/dev-talos.yml tests/exodev.yaml
