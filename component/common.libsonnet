...
local getDefaultInputs(name, serviceParams, plans, xrd, appuioManaged) =
  ...
  + {
    ...
    [if std.objectHas(cluster, 'tenant') && cluster.tenant == 'c-servala' && std.objectHas(facts, 'distribution') && facts.distribution == 'talos' then 'claimAnnotationProductID']: 'servala.com/erp_product_id_resource',
