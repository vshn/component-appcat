...
local getRedisHARules(serviceName) = [
  {
    ...
    annotations: {
      ...
      runbook_url: 'https://kb.vshn.ch/app-catalog/framework/runbooks/AppCatRedis.html',
    },
        ...
        rules: [
                 {
                   ...
                   annotations: {
                     ...
                     runbook_url: 'https://kb.vshn.ch/app-catalog/framework/runbooks/GuaranteedUptimeTarget.html',
                   },
                   labels: {
                     OnCall: '{{ if eq $labels.sla "guaranteed" }}true{{ else }}false{{ end }}',
                     service: serviceName,
