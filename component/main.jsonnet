...

{
  ...
  [if params.slos.enabled && vars.isServiceCluster && !std.isEmpty(params.slos.sli_exporter.controlPlaneKubeconfig) then 'sli_exporter/10_service_cluster_kubeconfig']: controlKubeConfig,
