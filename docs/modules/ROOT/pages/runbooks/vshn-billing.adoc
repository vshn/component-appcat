...
The authoritative billing documentation is maintained in the Application Catalog knowledge base:
https://kb.vshn.ch/app-catalog/framework/billing.html[AppCat Billing^]
====
